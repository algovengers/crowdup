  ...
  return (
    <div className=" flex flex-col gap-2 p-4 bg-slate-100 rounded-lg">
        <div className=" flex flex-row items-center gap-2">
            <div ><img src="https://picsum.photos/200" alt="" className="rounded-full h-16" /></div>
            <div>OPENAI</div>
        </div>
      <div className=" w-full bg-gray-600 rounded">
      <div className="h-2 bg-blue-300 rounded" style={{ width: `calc(${percentage}%)` }}></div>
      </div>
      <div className="text-gray-600"> <span className="text-xl text-black"> Rs {funded} </span> Funded out of Rs {required}</div>
        {/* <div>bar</div> */}
      <div>
      ...
      <div><a href="https://chat.openai.com/" className="text-sm text-blue-500">https://chat.openai.com/</a></div>
