...
const Sidebar = ({ role }) => {
  ...
  return (
    <>
      ...
      <aside id="logo-sidebar" className={`z-10 w-64 fixed inset-y-0 left-0 pt-[4rem] flex-shrink-0 lg:translate-x-0  bg-slate-900 transition-transform duration-300 ease-in-out transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'
        }`}>
