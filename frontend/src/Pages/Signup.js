...
const Signup = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-white via-white to-emerald-300 h-screen flex flex-col items-center justify-center">
        <div className="bg-gradient-to-t from-green-200 to-green-300 p-8 pt-6 rounded shadow-md w-96">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full ${submitted && notError
                ? "bg-gray-500"
                : "bg-green-600 hover:bg-green-700 duration-75"
        ...
        <div className="text-center text-slate-800 mt-4">
          ...
          <Link to="/login" className="text-green-800 font-bold tracking-wide">
            Log In
          </Link>
        </div>
      </div>
