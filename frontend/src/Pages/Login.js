...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-white via-white to-emerald-300 min-h-screen flex flex-col items-center justify-center">
        <div className="bg-gradient-to-t from-green-200 to-green-300 p-8 rounded shadow-md w-96">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              disabled={loading}
              className="w-full bg-green-600 hover:bg-green-700 duration-75 text-white p-2 rounded"
              type="submit"
            >
              Log In
            </button>
        ...
        <div className="text-center text-slate-800 mt-4">
          Need an account?{" "}
          <Link to="/signup" className="text-green-800 font-bold tracking-wide">
            Sign Up
          </Link>
        </div>
      </div>
